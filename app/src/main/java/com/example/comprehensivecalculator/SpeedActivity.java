...
public class SpeedActivity extends AppCompatActivity {
    ...
    private TextView meter_text,kilometer_text;
    double bs=0.001;
    int max_length=12;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        kilometer_text=(TextView)findViewById(R.id.kilometer);
//        返回功能
...
//        点击AC按钮，重置为0
        ac_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                common.acClick(meter_text,kilometer_text);
//                是否禁用数字按钮
