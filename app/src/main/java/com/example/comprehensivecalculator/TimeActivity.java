...
public class TimeActivity extends AppCompatActivity {
    ...
    private TextView minute_text,second_text;
    double bs=60;
    int max_length=12;
...
//        点击删除按钮
        del_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String str=common.delClick(minute_text,max_length,num1_btn,
...
//        点击AC按钮，重置为0
        ac_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                common.acClick(minute_text,second_text);
//                是否禁用数字按钮
...
//        点击小数点
        point_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                common.pointClick(minute_text,point_btn);
            }
        });
...
//    数值转换
        public void numChange(String meter_str) {
            minute_text.setText(meter_str);
            String str=common.numChange(meter_str,bs);
            second_text.setText(str);
}
}
