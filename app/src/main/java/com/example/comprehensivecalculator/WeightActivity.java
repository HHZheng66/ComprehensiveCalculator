...
public class WeightActivity extends AppCompatActivity {
    ...
    private TextView kilogram_text,gram_text;
    double bs=1000;
    int max_length=12;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        kilogram_text=(TextView)findViewById(R.id.kilogram);
        gram_text=(TextView)findViewById(R.id.gram);
//        返回功能
...
//        点击删除按钮
        del_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String str=common.delClick(kilogram_text,max_length,num1_btn,
...
//        点击AC按钮，重置为0
        ac_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                common.acClick(kilogram_text,gram_text);
//                是否禁用数字按钮
...
//        点击小数点
        point_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                common.pointClick(kilogram_text,point_btn);
            }
        });
...
//    数值转换
        public void numChange(String meter_str) {
            kilogram_text.setText(meter_str);
            String str=common.numChange(meter_str,bs);
            gram_text.setText(str);
}
}
